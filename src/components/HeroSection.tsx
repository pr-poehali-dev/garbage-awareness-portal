        ...
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          <div className="mb-6 inline-block">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h1 className="text-3xl md:text-5xl font-black bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent animate-gradient">
                SIRIUS55
              </h1>
              <div className="text-3xl md:text-5xl animate-bounce" style={{animationDelay: '0.2s'}}>🚀</div>
            </div>
            <p className="text-base md:text-xl font-bold text-emerald-600 animate-pulse">
              Омск за чистое будущее планеты!
            </p>
          </div>
          <Badge className="mb-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white text-sm md:text-base px-4 py-1.5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <Card className="p-6 bg-white/90 backdrop-blur-sm hover:shadow-2xl hover:scale-105 transition-all duration-300 animate-scale-in cursor-pointer group">
              ...
              <p className="text-xs md:text-sm text-muted-foreground font-semibold">тонн мусора производится в мире ежегодно</p>
            </Card>
            ...
            <Card className="p-6 bg-white/90 backdrop-blur-sm hover:shadow-2xl hover:scale-105 transition-all duration-300 animate-scale-in cursor-pointer group" style={{animationDelay: '0.1s'}}>
              ...
              <p className="text-xs md:text-sm text-muted-foreground font-semibold">пунктов приёма вторсырья в Омске</p>
            </Card>
            ...
            <Card className="p-6 bg-white/90 backdrop-blur-sm hover:shadow-2xl hover:scale-105 transition-all duration-300 animate-scale-in cursor-pointer group" style={{animationDelay: '0.2s'}}>
              ...
              <p className="text-xs md:text-sm text-muted-foreground font-semibold">мусора перерабатывается</p>
            </Card>
          </div>
        </div>
      </div>
