      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-8 mb-8">
            ...
            <Card className="bg-gradient-to-br from-yellow-400 to-orange-500 border-4 border-white p-6 text-center">
              <div className="text-5xl mb-3">⭐</div>
              <h3 className="text-2xl font-black text-white mb-2">БАЛЛЫ</h3>
              <p className="text-6xl font-black text-white bg-orange-600/50 rounded-xl py-2">
                {totalPoints}
              </p>
            </Card>

            <Card className="bg-gradient-to-br from-blue-400 to-cyan-500 border-4 border-white p-6 text-center">
              <div className="text-5xl mb-3">🎯</div>
              <h3 className="text-2xl font-black text-white mb-2">ОБНАРУЖЕНО</h3>
              <p className="text-6xl font-black text-white bg-blue-600/50 rounded-xl py-2">
                {detectionsCount}
              </p>
            </Card>
          </div>
